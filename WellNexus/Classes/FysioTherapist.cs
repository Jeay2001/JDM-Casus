...
namespace WellNexus
{
    internal class FysioTherapist : User
    {
        ...
        public FysioTherapist(int id, string FirstName, string LastName, string Username, string Email, string Password, string Address, int PhoneNumber) : base(id, FirstName, LastName, Username, Email, Password)
        {
            this.Id = id;
